  ...
  return (
    <div
      className={cn(
        ...
        isComplete ? "border-zinc-700 bg-zinc-900/50" : "border-zinc-800 bg-zinc-900"
      )}
    >
                  ...
                  <div key={field.key}>
                    ...
                    {field.type === "textarea" ? (
                      <textarea
                        ...
                        onChange={(e) => setLocal(step.id, field.key, e.target.value)}
            ...
            <div className="space-y-3">
              {step.copyBlocks.map((block, i) => (
                <div key={i} className="rounded-md bg-zinc-950 border border-zinc-800">
                  ...
                  <pre className="text-xs text-zinc-300 p-3 whitespace-pre-wrap leading-relaxed font-mono">
                    {block.content}
                  </pre>
                </div>
              ))}
